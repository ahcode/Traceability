...
from pyTraceability.api_interface import send_transaction, check_version, check_key
...
class Connection():
    ...
    def __newtransaction(self, transaction_type, mode, receiver, data):
        ...
        transaction.extend([("timestamp", str(time())), ("data", ordered_data)])
